...
import re
from aoc_2020_13 import parse_input_data, parse_bus_schedule, find_earliest_bus, find_sequential_schedule_start_time
...
def test_part_2_basic_input():
    ...
    start_time = find_sequential_schedule_start_time(buses)
